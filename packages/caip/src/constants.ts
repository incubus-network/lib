...
export const blackfuryAssetId: AssetId = 'eip155:710/slip44:60'
...
export const CHAIN_REFERENCE = {
  ...
  BlackfuryMainnet: '710', //https://community.optimism.io/docs/useful-tools/networks/#highbury-mainnet
...
export const ASSET_REFERENCE = {
  ...
  Blackfury: '710', // evm chain which uses ethereum derivation path as common practice
