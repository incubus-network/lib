...
import * as ethereum from './BlackfuryChainAdapter'
...
describe('BlackfuryChainAdapter', () => {
  const gasPrice = '42'
  ...
  const makeGetAccountMockResponse = (balance: {
    ...
    tokens: [
      {
        assetId: 'eip155:710/erc20:0xc770eefad204b5180df6a14ee197d99d808ee52d',
  ...
  const makeChainAdapterArgs = (overrideArgs?: {
    providers?: { http: unchained.blackfury.V1Api }
    chainId?: EvmChainId
  }): ChainAdapterArgs<unchained.blackfury.V1Api> =>
    merge(
      {
        providers: {
          http: {} as unknown as unchained.blackfury.V1Api,
          ws: {} as unchained.ws.Client<unchained.blackfury.Tx>,
        },
        rpcUrl: '',
      },
      overrideArgs,
  ...
  describe('getFeeAssetId', () => {
    it('should return the correct fee assetId', () => {
      const adapter = new blackfury.ChainAdapter(makeChainAdapterArgs())
  ...
  describe('getFeeData', () => {
    it('should return current network fees', async () => {
      ...
      } as unknown as unchained.blackfury.V1Api
    ...
    it('should sign a properly formatted txToSign object', async () => {
      ...
      const tx = {
        ...
        txToSign: {
          ...
          value: '0x0',
          to: EOA_ADDRESS,
          chainId: Number(CHAIN_REFERENCE.BlackfuryMainnet),
  ...
  describe('buildSendTransaction', () => {
    it('should throw if passed tx has no "to" property', async () => {
      ...
      } as unknown as BuildSendTxInput<KnownChainIds.BlackfuryMainnet>
