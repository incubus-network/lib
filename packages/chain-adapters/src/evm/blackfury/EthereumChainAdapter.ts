...
const SUPPORTED_CHAIN_IDS = [KnownChainIds.BlackfuryMainnet]
const DEFAULT_CHAIN_ID = KnownChainIds.BlackfuryMainnet

export class ChainAdapter extends EvmBaseAdapter<KnownChainIds.BlackfuryMainnet> {
  ...
  getType(): KnownChainIds.BlackfuryMainnet {
    return KnownChainIds.BlackfuryMainnet
  }
  ...
  async getFeeData(
    input: GetFeeDataInput<KnownChainIds.BlackfuryMainnet>,
  ): Promise<FeeDataEstimate<KnownChainIds.BlackfuryMainnet>> {
